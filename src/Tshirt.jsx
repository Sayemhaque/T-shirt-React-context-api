...
const Tshirt = ({shirt}) => {
    ...
    return (
        <div >
            <div className='border-2 border-blue-300 rounded-md hover:shadow-2xl duration-500 cursor-pointer'>
                ...
                <p className='font-bold text-xl py-2'>Price : {price}</p>
                 <button className='px-2 py-1 border border-blue-500 rounded-lg'>Add to cart</button>
                </div>
